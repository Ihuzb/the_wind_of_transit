module.exports = {
    ...
    selectMusicCommentInfo:"SELECT ml.music_name,ml.music_img,comment_text FROM music_comment_list LEFT JOIN music_list ml on music_comment_list.music_id = ml.id WHERE conmment_type=1  LIMIT ?,10;"
}